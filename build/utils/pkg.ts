 ...
 * @LastEditors: 华松林
 * @LastEditTime: 2021-11-30 10:00:54
 * @FilePath: /finches-ui/build/utils/pkg.ts
 */
...
export const pathRewriter = (module: Module) => {
  ...
  return (id: string) => {
    // id = id.replaceAll(`${EP_PREFIX}/theme-chalk`, 'finches-ui/theme-chalk')
    // // TODO: handle @finches-ui/icons
