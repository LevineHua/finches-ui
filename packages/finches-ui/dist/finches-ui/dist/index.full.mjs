  ...
  setup(props, ctx) {
    ...
    return () => {
      ...
      return h$2(script$D, {
        ...
        default: (scopedProps) => h$2(panel, scopedProps)
      });
    };
  }
});
...
var NodeContent = defineComponent({
  ...
  render() {
    ...
    return h$2("span", { class: "el-cascader-node__label" }, renderLabelFn ? renderLabelFn({ node, data }) : label);
  }
});
...
var ElDatePickerCell = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (picker == null ? void 0 : picker.ctx.slots.default) ? picker.ctx.slots.default(cell) : h$2("div", {
  ...
  setup(props, ctx) {
    ...
    return () => {
      ...
      return h$2(script$D, {
        ...
        default: (scopedProps) => h$2(getPanel(props.type), scopedProps),
  ...
  setup(props, { slots }) {
    ...
    function render() {
      ...
      if (props.isAutoWidth) {
        ...
        return h$2(Fragment, { ref: el }, (_b = slots.default) == null ? void 0 : _b.call(slots));
      }
    }
    return render;
  }
